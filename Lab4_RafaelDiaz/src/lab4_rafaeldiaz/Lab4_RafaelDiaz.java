                ...
                case 1:
                    ...
                    switch (op) {
                        ...
                        case 4:
                            ...
                            sc = new Scanner(System.in);
                            System.out.println("Donde lo desea transferir?");
                ...
                case 3:
                    ...
                    switch (op3) {
                        ...
                        case 2:
                            ...
                            System.out.println("\nCual producto desea modificar? 0,1,2...");
                            ...
                            switch (posmodi) {
                                case 1:
                                    ...
                                    vidautil = sc.nextDouble();
                                    productos.get(modpro).setVidautil(vidautil);
                                    break;
                                case 2:
                                    System.out.println("Ingrese nuevo precio");
                                    precio = sc.nextDouble();
                                    productos.get(modpro).setPrecio(precio);
                                    break;
                                case 3:
                                    System.out.println("Ingrese nuevo tamaño");
                                    tamano = sc.nextDouble();
                                    productos.get(modpro).setTamano(tamano);
                                    break;
                                case 4:
                                    sc = new Scanner(System.in);
                                    ...
                                    descripcion = sc.nextLine();
                                    sc = new Scanner(System.in);
                                    productos.get(modpro).setDescripcion(descripcion);
                                    break;
                                case 5:
                                    sc = new Scanner(System.in);
                                    System.out.println("Ingrese nuevo nombre");
                                    nombre2 = sc.nextLine();
                                    sc = new Scanner(System.in);
                                    productos.get(modpro).setNombre(nombre2);
                                    break;
                                case 6:
                                    System.out.println("Ingrese nuevo numero de productos");
                                    numeroproductos = sc.nextInt();
                                    productos.get(modpro).setNumeroproductos(numeroproductos);
                                    break;
                                default:
                                    System.out.println("Esa no es una opcion");
                                    break;
